...
<div class="cpl-md-12 col-12 comments">
    ...
    <form action="<?=BASE_URL . "single-page.php?post=$page"?>" method="post">
        ...
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Iesaistīties diskusijā</label>
            <textarea name="comment" class="form-control" id="exampleFormControlTextarea1" rows="4"></textarea>
        </div>
        <div class="col-12">
            <button type="submit" name="goComment" class="btn btn-primary">Publicēt</button>
        </div>
    </form>

    <?php if(count($comments) > 0): ?>
        <div class="row all-comments">
            <h3 class="col-12">Komentāri</h3>
